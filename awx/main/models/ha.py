...
class InstanceGroup(HasPolicyEditsMixin, BaseModel, RelatedJobsMixin):
    ...
    @staticmethod
    def fit_task_to_most_remaining_capacity_instance(task, instances, impact=None, capacity_type=None, punish_hybrid=False):
        ...
        for i in instances:
            ...
            if punish_hybrid and i.node_type == 'hybrid':
