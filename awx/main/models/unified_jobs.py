...
from awx.main.constants import CAN_CANCEL, JOB_VARIABLE_PREFIXES
...
class UnifiedJob(
    ...
    event_processing_finished = models.BooleanField(
        default=False, editable=False, help_text=_('Indicates whether all of the events generated by this unified job have been saved to the database.')
    )
