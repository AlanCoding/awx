    ...
    def status_handler(self, status_data, runner_config):
        ...
        if status_data['status'] == 'starting':
            ...
            with disable_activity_stream():
                self.instance.job_args = json.dumps(runner_config.command)
...
class RunnerCallbackForProjectUpdate(RunnerCallback):
    ...
    def __init__(self):
        super(RunnerCallbackForProjectUpdate, self).__init__()
...
class RunnerCallbackForAdHocCommand(RunnerCallback):
    ...
    def __init__(self):
        super(RunnerCallbackForAdHocCommand, self).__init__()
        self.host_map = {}
