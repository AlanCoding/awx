...
LOGGING = {
    ...
    'loggers': {
        ...
        # NOTE: the dispatcherd main process will turn off the dynamic log filter
        # so the level here is the way to control its verbosity
        'dispatcherd': {'handlers': ['dispatcher', 'console'], 'level': 'DEBUG'},
    },
}
